...
<link rel="stylesheet" type="text/css" href="/bootstrap/bootstrap/css/chosen.css" />
...
<!-- BEGIN JAVASCRIPTS(Load javascripts at bottom, this will reduce page load time) -->
	...
	<script type="text/javascript" src="/bootstrap/bootstrap/js/jquery.validate.min.js"></script>

	<script type="text/javascript" src="/bootstrap/bootstrap/js/additional-methods.min.js"></script>

	<script type="text/javascript" src="/bootstrap/bootstrap/js/jquery.bootstrap.wizard.min.js"></script>

	<script type="text/javascript" src="/bootstrap/bootstrap/js/chosen.jquery.min.js"></script>
			...
			<div class="span12">
				<div class="portlet box blue" id="form_wizard_1"> 
					...
					<div class="portlet-title">
						...
						<div class="caption">
							<i class="icon-cogs"></i>用户注册--<span class="step-title">Step 1 of 4</span>
						</div>
											...
											<div class="navbar-inner">
												...
												<ul class="row-fluid">
													...
													<li class="span3">
														...
														<span class="desc"><i class="icon-ok"></i> 认证信息</span>   
										...
										<div class="tab-content">
											...
											<div class="tab-pane active" id="tab1">
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<span class="help-inline">输入合理的长度，确保安全。</span>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<span class="help-inline">无比填写正确的邮箱，我们需要她。</span>
											...
											<div class="tab-pane" id="tab2">
												...
												<div class="control-group">
													...
													<label class="control-label">住址信息</label>
												...
												<div class="control-group">
													...
													<div class="controls">
														...
														<span class="help-inline">街道信息可选</span>
													</div>
											...
											<div class="tab-pane" id="tab3">
												...
												<div class="control-group">
													...
													<label class="control-label">所在学院<span class="required">*</span></label>

													<div class="controls">

														<input type="text" class="span6 m-wrap" name="school"/>
												...
												<div class="control-group">
													...
													<label class="control-label">入学年月(MM/YYYY)<span class="required">*</span></label>
