...
<form action="NotifyAdd.php" method="post" class="form-horizontal"> 
			...
			<div class="span6">
				...
				<div class="portlet box blue tabbable" style="width:800px;">
							...
							<div class="portlet-title">
								...
								<div class="caption"><i class="icon-reorder"></i>新增通知</div>
							...
							<div class="portlet-body">
								...
								<div class="control-group">
													...
													<label class="control-label">通知类别</label>
												...
												<div style="margin-left:100px;">
													<textarea name="TextArea" cols="100" rows="8" style="padding: 0 8% 0 8%;width:680px;height:300px;"></textarea>
												</div>
