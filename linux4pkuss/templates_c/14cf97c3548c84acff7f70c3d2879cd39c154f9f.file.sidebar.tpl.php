<?php /* Smarty version Smarty-3.1.19, created on 2014-09-10 03:15:14
         compiled from "/var/www/linux4pkuss/linux4pkuss/templates/user/sidebar.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1909302154540f2220a9a0c8-92414720%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '14cf97c3548c84acff7f70c3d2879cd39c154f9f' => 
    array (
      0 => '/var/www/linux4pkuss/linux4pkuss/templates/user/sidebar.tpl',
      1 => 1410289959,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '1909302154540f2220a9a0c8-92414720',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.19',
  'unifunc' => 'content_540f2220a9fa35_70382508',
  'has_nocache_code' => false,
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_540f2220a9fa35_70382508')) {function content_540f2220a9fa35_70382508($_smarty_tpl) {?>	<div class="page-sidebar nav-collapse collapse">

			<!-- BEGIN SIDEBAR MENU -->

			<ul class="page-sidebar-menu">
				<li class="start "><a href="/controller/user/userHandler.php?type=profile"> <i
						class="icon-home"></i> <span class="title">个人信息</span>
				</a></li>

				<li class=""><a href="javascript:;"> <i class="icon-cogs"></i>

						<span class="title">我的设置</span> <span class="arrow "></span>
				...
				<li class=""><a href="javascript:;"> <i
						class="icon-bookmark-empty"></i> <span class="title">我的收藏</span> <span
						class="arrow "></span>
				...
				<li class=""><a href="javascript:;"> <i class="icon-table"></i>
						...
						<span class="title">我的资源</span> <span class="arrow "></span>
				...
				<li class=""><a href="javascript:;"> <i
						class="icon-briefcase"></i> <span class="title">我的文章</span> <span
						class="arrow "></span>
				...
				<li class=""><a href="javascript:;"> <i
						class="icon-gift"></i> <span class="title">Extra</span><span class="arrow"></span>
				...
				<li><a class="active" href="javascript:;"> <i
						class="icon-sitemap"></i> <span class="title">我的日历</span> <span
						class="arrow "></span>
